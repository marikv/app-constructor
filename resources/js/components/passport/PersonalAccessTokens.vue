            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    ...
                    <p class="mb-0" v-if="tokens.length === 0">
                        Вы не создали никаких персональных токенов доступа.
                    </p>
                    ...
                    <div class="modal-body">
                        ...
                        <form role="form" @submit.prevent="store">
                            ...
                            <div class="form-group row" v-if="scopes.length > 0">
                                <label class="col-md-4 col-form-label">Области применения</label>
        ...
        <div class="modal fade" id="modal-access-token" tabindex="-1" role="dialog">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p>
                            Вот ваш новый личный токен доступа.
                            Это единственный раз, когда он будет показан, так что не теряйте его!
                                                        
